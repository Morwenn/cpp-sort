***WARNING:** sorting functions are deprecated in version 1.8.0 and removed in version 2.0.0, see [issue #167](https://github.com/Morwenn/cpp-sort/issues/167) for the rationale.*
