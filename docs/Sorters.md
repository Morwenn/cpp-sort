...
If you want to read more about sorters and/or write your own, then you should have a look at [the dedicated page][writing-a-sorter] or at [a specific example][writing-a-bubble-sorter].
