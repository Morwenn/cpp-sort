        ...
        >
    {
        ...
        constexpr auto operator()(Iterator first, Iterator last, Compare compare) const
            -> detail::enable_if_t<
                ...
                >::value,
                decltype(Sorter::operator()(
                    std::move(first), std::move(last),
                    refined<decltype(*first)>(utility::as_function(std::move(compare)))
                ))
            >
        {
            return Sorter::operator()(
                std::move(first), std::move(last),
                refined<decltype(*first)>(utility::as_function(std::move(compare)))
            );
        }
        ...
        constexpr auto operator()(Iterable&& iterable, Compare compare) const
            -> detail::enable_if_t<
                ...
                decltype(Sorter::operator()(
                    ...
                    refined<decltype(*std::begin(iterable))>(utility::as_function(std::move(compare)))
                ))
            >
        {
            return Sorter::operator()(
        ...
        constexpr auto operator()(Iterator first, Iterator last, Projection projection) const
            -> detail::enable_if_t<
                ...
                decltype(Sorter::operator()(
                    std::move(first), std::move(last),
                    refined<decltype(*first)>(utility::as_function(std::move(projection)))
                ))
            >
        {
            return Sorter::operator()(
        ...
        constexpr auto operator()(Iterable&& iterable, Projection projection) const
            -> detail::enable_if_t<
                ...
                decltype(Sorter::operator()(
                    std::forward<Iterable>(iterable),
                    refined<decltype(*std::begin(iterable))>(utility::as_function(std::move(projection)))
                ))
            >
        {
            return Sorter::operator()(
        ...
        constexpr auto operator()(Iterable&& iterable, Projection projection) const
            -> detail::enable_if_t<
                ...
                >::value,
                decltype(Sorter::operator()(
                    std::forward<Iterable>(iterable), std::less<>{},
                    refined<decltype(*std::begin(iterable))>(utility::as_function(std::move(projection)))
                ))
            >
        {
        ...
        constexpr auto operator()(Iterable&& iterable, Projection projection) const
            -> detail::enable_if_t<
                ...
                >::value,
                decltype(Sorter::operator()(
                    std::begin(iterable), std::end(iterable), std::less<>{},
                    refined<decltype(*std::begin(iterable))>(utility::as_function(std::move(projection)))
                ))
            >
        {
        ...
        constexpr auto operator()(Iterable&& iterable, std::less<> compare, Projection projection) const
            -> detail::enable_if_t<
                ...
                >::value,
                decltype(Sorter::operator()(
                    std::forward<Iterable>(iterable), compare,
                    refined<decltype(*std::begin(iterable))>(utility::as_function(std::move(projection)))
                ))
            >
        {
        ...
        constexpr auto operator()(Iterable&& iterable, std::less<> compare, Projection projection) const
            -> detail::enable_if_t<
                ...
                >::value,
                decltype(Sorter::operator()(
                    std::begin(iterable), std::end(iterable), compare,
                    refined<decltype(*std::begin(iterable))>(utility::as_function(std::move(projection)))
                ))
            >
        {
