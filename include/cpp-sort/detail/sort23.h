 ...
 */
#ifndef CPPSORT_DETAIL_SORT23_H_
#define CPPSORT_DETAIL_SORT23_H_
...
namespace detail
{
    ...
    struct sorter_n<23u>
    {
            ...
            -> void
        {
            ...
            if (compare(begin[11u], begin[0u])) {
                swap(begin[0u], begin[11u]);
            }
            ...
            if (compare(begin[11u], begin[2u])) {
                swap(begin[2u], begin[11u]);
            }
...
#endif // CPPSORT_DETAIL_SORT23_H_
