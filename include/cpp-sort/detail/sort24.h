 ...
 */
#ifndef CPPSORT_DETAIL_SORT24_H_
#define CPPSORT_DETAIL_SORT24_H_
...
namespace detail
{
    ...
    struct sorter_n<24u>
    {
            ...
            -> void
        {
            ...
            if (compare(begin[21u], begin[16u])) {
                swap(begin[16u], begin[21u]);
            }
            ...
            if (compare(begin[12u], begin[1u])) {
                swap(begin[1u], begin[12u]);
            }
            ...
            if (compare(begin[19u], begin[8u])) {
                swap(begin[8u], begin[19u]);
            }
            ...
            if (compare(begin[21u], begin[9u])) {
                swap(begin[9u], begin[21u]);
            }
            ...
            if (compare(begin[21u], begin[11u])) {
                swap(begin[11u], begin[21u]);
            }
            if (compare(begin[18u], begin[9u])) {
                swap(begin[9u], begin[18u]);
            }
            if (compare(begin[19u], begin[10u])) {
                swap(begin[10u], begin[19u]);
            }
...
#endif // CPPSORT_DETAIL_SORT24_H_
