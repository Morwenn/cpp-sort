        ...
        splay_tree_base
    {
        public:
                ...
                root_(buffer_.begin()) // Original root is first element
            {
                ...
                buffer_.emplace_back(mstd::iter_move(first), &sentinel_node_, &sentinel_node_, &sentinel_node_);
                ...
                while (true) {
                    if (comp(value_proj, proj(static_cast<node_type*>(node)->value))) {
                        if (node->left_child == &sentinel_node_) {
                            node->left_child = buffer_.emplace_back(mstd::iter_move(it), node, &sentinel_node_, &sentinel_node_);
                        ...
                        if (node->right_child == &sentinel_node_) {
                            node->right_child = buffer_.emplace_back(mstd::iter_move(it), node, &sentinel_node_, &sentinel_node_);
