...
namespace detail
{
    ...
    auto indiesort(Sorter&& sorter, ForwardIterator first, ForwardIterator last,
        ...
        -> decltype(std::forward<Sorter>(sorter)(
            ...
            std::move(compare),
            &it_and_index<ForwardIterator>::original_location | utility::indirect(projection)
        ))
#else
        -> std::enable_if_t<
                has_comparison_projection_sort_iterator<
                    ...
                    Compare,
                    decltype(&it_and_index<ForwardIterator>::original_location | utility::indirect(projection))
                >::value
            >
#endif
    {
        ...
        std::forward<Sorter>(sorter)(
            ...
            &item_index_tuple::original_location | utility::indirect(projection)
        );
#else
