...
namespace detail
{
    ...
    struct sorter_n<31u>
    {
            ...
            -> void
        {
            ...
            if (compare(begin[19u], begin[16u])) {
                swap(begin[16u], begin[19u]);
            }
            ...
            if (compare(begin[21u], begin[18u])) {
                swap(begin[18u], begin[21u]);
            }
            ...
            if (compare(begin[27u], begin[24u])) {
                swap(begin[24u], begin[27u]);
            }
            ...
            if (compare(begin[29u], begin[26u])) {
                swap(begin[26u], begin[29u]);
            }
            ...
            if (compare(begin[27u], begin[20u])) {
                swap(begin[20u], begin[27u]);
            }
            ...
            if (compare(begin[29u], begin[22u])) {
                swap(begin[22u], begin[29u]);
            }
            ...
            if (compare(begin[27u], begin[22u])) {
                swap(begin[22u], begin[27u]);
            }
            ...
            if (compare(begin[27u], begin[13u])) {
                swap(begin[13u], begin[27u]);
            }
            ...
            if (compare(begin[23u], begin[13u])) {
                swap(begin[13u], begin[23u]);
            }
