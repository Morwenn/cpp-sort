...
namespace cppsort::detail::spreadsort::detail
{
        ...
        -> std::size_t
    {
        ...
        static_assert(log_min_split_count <= max_splits && log_min_split_count > 0);
        static_assert(max_splits > 1 && max_splits < (8 * sizeof(unsigned)));
        static_assert(max_finishing_splits >= max_splits && max_finishing_splits < (8 * sizeof(unsigned)));
