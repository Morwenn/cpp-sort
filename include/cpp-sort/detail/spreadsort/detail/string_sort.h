...
namespace cppsort::detail::spreadsort::detail
{
        ...
        -> void
    {
      ...
      for (auto current = *local_bin; current < next_bin_start;
          ++current) {
      ...
      *local_bin = next_bin_start;
      ...
      bins[last_bin] = last;
      //Recursing
      auto lastPos = bin_cache[cache_offset];
