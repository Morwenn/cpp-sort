...
namespace detail
{
        ...
        -> void
    {
        ...
        //
        // The bad_distribution heuristic is selected so that this optimization only
        // happens when the number of encroaching lists is greater than the average
        // size of the encroaching lists to merge.
        //
