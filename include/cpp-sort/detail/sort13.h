...
namespace detail
{
    ...
    struct sorter_n<13u, FallbackSorter>
    {
            ...
            -> void
        {
            ...
            if (compare(iterable[7u], iterable[1u])) {
                swap(iterable[1u], iterable[7u]);
            }
            ...
            if (compare(iterable[12u], iterable[0u])) {
                swap(iterable[0u], iterable[12u]);
            }
            ...
            if (compare(iterable[11u], iterable[8u])) {
                swap(iterable[8u], iterable[11u]);
            }
