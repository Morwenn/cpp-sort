...
namespace detail
{
    ...
    struct sorter_n<32u, FallbackSorter>
    {
            ...
            -> void
        {
            ...
            if (compare(iterable[31u], iterable[15u])) {
                swap(iterable[15u], iterable[31u]);
            }
            ...
            if (compare(iterable[31u], iterable[23u])) {
                swap(iterable[23u], iterable[31u]);
            }
            ...
            if (compare(iterable[31u], iterable[27u])) {
                swap(iterable[27u], iterable[31u]);
            }
            ...
            if (compare(iterable[31u], iterable[29u])) {
                swap(iterable[29u], iterable[31u]);
            }
            ...
            if (compare(iterable[31u], iterable[30u])) {
                swap(iterable[30u], iterable[31u]);
            }
