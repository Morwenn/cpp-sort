...
namespace cppsort
{
        ...
        >
    {
        ...
        auto operator()(std::list<Args...>& range) const
            -> void
        {
            detail::list_mel_sort(range, std::less{}, utility::identity{});
        }
        ...
        auto operator()(std::list<Args...>& range, Compare compare) const
            ...
            >
        {
            detail::list_mel_sort(range, std::move(compare), utility::identity{});
        }
        ...
        auto operator()(std::list<Args...>& range, Projection projection) const
            ...
            >
        {
            detail::list_mel_sort(range, std::less{}, std::move(projection));
        }
        ...
        auto operator()(std::list<Args...>& range,
            ...
            -> void
        {
            detail::list_mel_sort(range, std::move(compare), std::move(projection));
        }
        ...
        auto operator()(std::forward_list<Args...>& range) const
            -> void
        {
            detail::flist_mel_sort(range, std::less{}, utility::identity{});
        }
        ...
        auto operator()(std::forward_list<Args...>& range, Compare compare) const
            ...
            >
        {
            detail::flist_mel_sort(range, std::move(compare), utility::identity{});
        }
        ...
        auto operator()(std::forward_list<Args...>& range, Projection projection) const
            ...
            >
        {
            detail::flist_mel_sort(range, std::less{}, std::move(projection));
        }
        ...
        auto operator()(std::forward_list<Args...>& range,
            ...
            -> void
        {
            detail::flist_mel_sort(range, std::move(compare), std::move(projection));
        }
    };
}
