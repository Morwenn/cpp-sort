...
namespace cppsort
{
        ...
        >
    {
        ...
        auto operator()(std::list<Args...>& collection) const
            -> void
        {
            detail::list_mel_sort(collection, std::less{}, std::identity{});
        }
        ...
        auto operator()(std::list<Args...>& collection, Compare compare) const
            -> void
        {
            detail::list_mel_sort(collection, std::move(compare), std::identity{});
        }
        ...
        auto operator()(std::list<Args...>& collection, Projection projection) const
            -> void
        {
            detail::list_mel_sort(collection, std::less{}, std::move(projection));
        }
        ...
        auto operator()(std::list<Args...>& collection,
            ...
            -> void
        {
            detail::list_mel_sort(collection, std::move(compare), std::move(projection));
        }
        ...
        auto operator()(std::forward_list<Args...>& collection) const
            -> void
        {
            detail::flist_mel_sort(collection, std::less{}, std::identity{});
        }
        ...
        auto operator()(std::forward_list<Args...>& collection, Compare compare) const
            -> void
        {
            detail::flist_mel_sort(collection, std::move(compare), std::identity{});
        }
        ...
        auto operator()(std::forward_list<Args...>& collection, Projection projection) const
            -> void
        {
            detail::flist_mel_sort(collection, std::less{}, std::move(projection));
        }
        ...
        auto operator()(std::forward_list<Args...>& collection,
            ...
            -> void
        {
            detail::flist_mel_sort(collection, std::move(compare), std::move(projection));
        }
    };
}
